...
try:
    return_info = subprocess.Popen(install_pyqt5_Cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
    while True:
    ...
    if return_info.returncode:
        raise subprocess.CalledProcessError(return_info.returncode, install_pyqt5_Cmd)
except Exception as e:
    print(f"=== PyQt5 installation failed! Error: {str(e)} ===")

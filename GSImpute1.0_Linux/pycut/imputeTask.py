...
import joblib
import math
from pycut.func import  getTestAllMissing_index,cal_distImpute
import joblib
import logging, os
...
def ImputeTask(dataName,dataType,time,loop_num_all,window_size,dirPath):
    stride=1
    ...
    print("The number of loci for imputation is "+str(all_imp_test_data[0]))
    print("The number of samples for imputation is "+str(all_imp_test_data[1]))
    print("The missing rate of markers is " + str(all_imp_test_data[2])+'%')

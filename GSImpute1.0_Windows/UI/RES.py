...
def to_RES(self,task_num,data_A_path,data_B_path,panel_path,dirPath):
    ...
    if (data1Type == 'vcf'):
        ...
        if(csvData==-1):
            ...
            return 301
    gc.collect() 
    pycut.reconstructTask.Restructure(self.task_state_Signal,self.pro_Signal,self.task_list_Signal,data1Name,data1Type, data2Name, dirPath, subset_num,train_loop_num,window_size,task_num)
